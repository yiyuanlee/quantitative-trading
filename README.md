...
- [x] **V1.0**: 基础均线交叉策略
- [x] **V2.0**: SMA 200 过滤 + 固定止损
- [x] **V3.0**: ATR 动态止损 + 移动止盈
- [x] **V4.0**: 多标的组合回测
- [x] **V5.0**: IBKR 模拟账户实盘测试（ib_insync）
- [x] **V6.0**: 参数配置化管理（config.yaml）
- [x] **V7.0**: 策略优化（RSI确认 + ADX趋势强度）
- [x] **V8.0**: 实盘交易系统（完整风控 + 订单成交确认）
- [ ] **V8.1**: 参数优化框架 + 自动化参数搜索
- [ ] **V9.0**: 日内交易模式 + 高频扫描
